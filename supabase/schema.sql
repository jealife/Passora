...
create table if not exists public.events (
  ...
  gift_message           text,
  gift_details           text,
  gift_qr_image_url      text,
  show_gifts             boolean not null default true,
  guest_notes_title      text,
  guest_notes_text       text,
  show_guest_notes       boolean not null default true,
